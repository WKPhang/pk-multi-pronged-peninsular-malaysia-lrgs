...
write.csv(expanded_list_h, "PATH/data/Extracted_human.csv", row.names = F)
write.csv(expanded_list_m, "PATH/data/Extracted_macaque.csv", row.names = F)
write.csv(expanded_list_v, "PATH/data/Extracted_vector.csv", row.names = F)
...
expanded_list_m <- read.csv("PATH/data/Extracted_macaque.csv")
expanded_list_v <- read.csv("PATH/data/Extracted_vector.csv")
expanded_list_h <- read.csv("PATH/data/Extracted_human.csv")
...
selected_expanded_list <- expanded_list_m
...
selected_dataframe <- m_df # CHANGE Accordingly
expanded_list_lag <- left_join(expanded_list_lag, selected_dataframe, 
                               by = join_by("id" == "m_samp_id"))
...
target_host_data <- expanded_list_lead # Change dataset HERE
colnames(target_host_data)
...
for (i in seq_len(nrow(cum_corr_matrix_table))){
  ...
  # Selected variables for correlation analysis
  corvar_a <- filtered_data$pk_rate # Change this variable
