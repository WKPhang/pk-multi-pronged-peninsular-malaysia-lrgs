...
m_shp <- st_read("PATH/data/m_UTM_47N.shp")
v_shp <- st_read("PATH/data/v_UTM_47N.shp")
h_shp <- st_read("PATH/data/h_UTM_47N.shp")
...
# Partial correlations between human and macaque sampling outcomes
str(h_m_20km_joined)
...
# Partial correlations between human and vector sampling outcomes
str(h_v_20km_joined)
...
# Partial correlations between macaque and vector sampling outcomes
str(m_v_20km_joined)
